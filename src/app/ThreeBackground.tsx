...
const ThreeBackground = () => {
    ...
    // 關鍵修正：將所有變數都放在 useEffect 的 scope 內
    // 或者明確定義類型，避免 noImplicitAny 錯誤
    ...
    useEffect(() => {
        ...
        const init = () => {
            ...
            if (mountRef.current) {
                mountRef.current.appendChild(statsInstance.dom);
            }
        ...
        return () => {
            if (mountRef.current) {
                ...
                if (stats) mountRef.current.removeChild(stats.dom);
            }
